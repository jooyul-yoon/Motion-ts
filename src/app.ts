...
abstract class CardImpl implements Card {
  get title(): string {
    return this._title;
  }
...
class NoteCard extends CardImpl {
  ...
  constructor(_title: string, private _note: string) {
    super(_title);
  }
...
class ToDoCard extends CardImpl {
  ...
  constructor(_title: string, _tasks: string) {
    super(_title);
...
class ImageCard extends CardImpl {
  constructor(_title: string, private url: string) {
    super(_title);
  }
  createElement(): HTMLElement {
    const elem: HTMLElement = document.createElement("li");
